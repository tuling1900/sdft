...
def main():
    train_data = load_jsonl("data/processed/gsm8k_train_500.jsonl")[:500]
    ...
    save_jsonl(results, "data/distilled/gsm8k_train_500_sdft_v2.jsonl")

    print("Saved to data/distilled/gsm8k_train_500_sdft_v2.jsonl")
